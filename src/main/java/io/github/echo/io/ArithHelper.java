...
public class ArithHelper {
	...
	public static double add(final double v1, final double v2) {
		final java.math.BigDecimal b1 = new java.math.BigDecimal(Double.toString(v1));
		final java.math.BigDecimal b2 = new java.math.BigDecimal(Double.toString(v2));
	...
	public static double round(final double v, final int scale) {
		...
		final java.math.BigDecimal b = new java.math.BigDecimal(Double.toString(v));
