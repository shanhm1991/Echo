...
public class Calculator {
	 ...
	 * @return
	 */
	private static String transform(final String expression) {
	...
	public double calculate(final String expression) {
		...
		while (!postfixStack.isEmpty()) {
			...
			if (!isOperator(currentValue.charAt(0))) {
				...
				final String tempResult = calculate(firstValue, secondValue, currentValue.charAt(0));
	 ...
	 * @return
	 */
	public boolean compare(final char cur, final char peek) {
	 ...
	 * @return
	 */
	private String calculate(final String firstValue, final String secondValue, final char currentOp) {
		String result = "";
		switch (currentOp) {
		case '+':
